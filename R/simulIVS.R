...
#'
#' @return This function returns \eqn{n} interval-valued responses to each of \eqn{k} items in a questionnaire contained in a matrix of dimensions \eqn{n} x \eqn{2k}
